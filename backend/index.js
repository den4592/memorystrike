...
app.use(
  cors({
    origin: "https://memorystrike.com", // 접근 권한을 부여하는 도메인
...
mongoose
  .connect(
    `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.wh8iel1.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`,
    { autoIndex: false }
  )
  .then(() => {
    app.listen(8080);
